...
router.post(
    ...
    [
        ...
        body('typeOfAnimals')
            .trim()
            .custom((value, { req }) => {
                if(value !== 'Cão' && value !== 'Gato' && value !== 'Cães e gatos') {
                    const error = new Error('Number of animals is not a number');
        ...
        body('typeOfProperty')
            .trim()
            .custom((value, { req }) => {
                if(value !== 'Apartamento' && value !== 'Moradia' && value !== 'Quinta' && value !== 'Hotel para cães') {
